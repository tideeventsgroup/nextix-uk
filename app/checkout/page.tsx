...
export default function Checkout(){
  ...
  useEffect(()=>{try{const saved=localStorage.getItem("nextix-basket");if(saved)setBasket(JSON.parse(saved));}catch{}},[]);
  ...
  function updateQuantity(quantity:number){const next={...basket,quantity};setBasket(next);localStorage.setItem("nextix-basket",JSON.stringify(next));}
