...
export default function Checkout(){
  ...
  function submitOrder(event:FormEvent<HTMLFormElement>){
    ...
    setSubmitting(true);
    window.setTimeout(()=>{
      setOrderRef(`CL-${Date.now().toString(36).toUpperCase().slice(-6)}`);
  ...
  if(!loaded) return <main className="checkout-page" id="top" aria-busy="true"><p className="checkout-loading">Loading your basket…</p></main>;
